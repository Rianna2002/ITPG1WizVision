...
xgb_model.load_model("hdb_xgboost_model.model")  # Load binary model
...
def get_prev_price(flat_type, year, month):
    ...
    # If no exact match, find the most recent available price
...
year = st.number_input("Year of Transaction", min_value=2000, max_value=2025, value=2023)
month_num = st.number_input("Month of Transaction (1-12)", min_value=1, max_value=12, value=1)

# Get previous month's resale price
