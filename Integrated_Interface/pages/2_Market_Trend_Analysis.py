...
def load_model():
    ...
    model.load_model("models/markettrendanalysis_xgboost_model.json")
    return model
...
if page == "Dashboard":
    ...
    with col1:
        st.image("images/XGBoost_AVP.png", caption="XGBoost Actual vs Predicted", use_container_width=True)

    with col2:
        st.image("images/LSTM_AVP.png", caption="LSTM Actual vs Predicted", use_container_width=True)

    with col3:
        st.image("images/ARIMA_AVP.png", caption="ARIMA Actual vs Predicted", use_container_width=True)
